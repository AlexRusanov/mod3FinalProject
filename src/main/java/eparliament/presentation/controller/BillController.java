...
public class BillController {
    ...
    @Autowired
    public BillController(BillService billService, SessionService sessionService) {
        this.billService = billService;
        this.sessionService = sessionService;
    }

    @GetMapping("{sessionId}/sesionbills")
    public String showSessionBills(Model model, @PathVariable("sessionId") Integer sessionId, @RequestParam(value = "page", defaultValue = "1") int page){
        ...
        model.addAttribute("sesssionbills", billService.getBySession(sessionId, offset, limit));
...
//    @GetMapping("{sessionId}/sesionbills/{billId}")
//    public String showSessionBill(Model, @PathVariable("billId") Integer billId){
//
//    }
}
